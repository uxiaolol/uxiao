...
--[[			local file,l,f,jiy,peny,ourline
		...
		elseif DmFindPic('999.bmp',85,673,184,688,206) and DmFindPic('999queding.bmp',85,543,493,558,507) then
			...
			--[[router()--]]
		--账号封停
		elseif DmFindPic('fenghao.bmp',85,514,177,534,194) and DmFindPic('fenghaoqueding.bmp',90,539,488,553,500) and isok[i] == 1 then
			click(x,y)
			...
			isok[i]=0
		--账号封停
		elseif DmFindPic('fenghao.bmp',85,514,177,534,194) and DmFindPic('fenghaoqueding.bmp',90,539,488,553,500) then
			click(x,y)
		--登录异常
...
function levelup()
	...
	while (i<3) do
		...
		elseif DmFindPic('eye.bmp',90,1035,216,1045,227) then
			clickone(x,y)  
		--佩戴装备
		elseif DmFindPic('ya.bmp',85,992,16,1003,33)==false and (DmFindPic('peidai.bmp',90,712,507,722,518) or DmFindPic('peidai1.bmp',85,709,470,721,485))then
			clickone(x,y)
		--整理背包
		...
		elseif count[i] > 10 and DmFindPic('bag.bmp',90,831,615,842,628) then
			mSleep(1000)
			touchDown(0,52,593)
			mSleep(1500)
			touchUp(0)
		...
		elseif (DmFindPicFuzzy('zhuan90.bmp',85,91,229,131,250,0xffffff) or DmFindPicFuzzy('1zhuan80.bmp',90,81,233,131,249,0xffffff)) and DmFindPic('bag.bmp',90,831,615,842,628) then
			...
			if DmFindPic('ksgj.bmp',85,950,467,961,480) then click(x,y) end
			logDebug('到达一转1')	
			isfinish[i] = 1
			time_table[i]=os.time()
		elseif (DmFindPicFuzzy('1zhuan95.bmp',90,81,232,131,249,0xffffff) or DmFindPicFuzzy('1zhuan951.bmp',90,82,230,131,250,0xffffff)) and DmFindPic('bag.bmp',90,831,615,842,628) then
			if DmFindPic('ksgj.bmp',85,950,467,961,480) then click(x,y) end
			logDebug('到达一转1')	
			isfinish[i] = 1
			time_table[i]=os.time()		
		elseif DmFindPicFuzzy('2zhuan1.bmp',90,81,233,120,251,0xffffff) and DmFindPic('bag.bmp',90,831,615,842,628) then
			if DmFindPic('ksgj.bmp',85,950,467,961,480) then click(x,y) end
			logDebug('到达一转1')	
			isfinish[i] = 1
			time_table[i]=os.time()			
		--都到二转了
		elseif DmFindPicFuzzy('dadao2.bmp',90,45,229,93,250,0xffffff) and DmFindPicFuzzy('2zhuan1.bmp',90,81,233,120,251,0xffffff)==false and DmFindPic('bag.bmp',90,831,615,842,628) then
			if DmFindPic('ksgj.bmp',85,950,467,961,480) then click(x,y) end
			logDebug('到达一转1')	
			isfinish[i] = 1
			time_table[i]=os.time()	
		elseif DmFindPicFuzzy('dadao2.bmp',90,45,229,93,250,0xffffff) and DmFindPic('ya.bmp',85,992,16,1003,33) and DmFindPic('bag.bmp',90,831,615,842,628) then
			if DmFindPic('ksgj.bmp',85,950,467,961,480) then click(x,y) end
			logDebug('到达一转1')	
			isfinish[i] = 1
			time_table[i]=os.time()	
		--转生图标
		elseif DmFindPicFuzzy('2zhuan1.bmp',90,81,233,120,251,0xffffff)==false and (DmFindPic('zhuansheng.bmp',75,932,297,943,306) or DmFindPic('zhuansheng1.bmp',80,526,385,534,393,i)) then
			click(x,y)						
		--任务停止移动之后点击主线任务	
		...
		elseif DmFindPic('zscg.bmp',85,307,509,316,519,i) then
			click(x,y)   
		--任务黄字
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi13.bmp',85,583,397,594,423,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)					
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi12.bmp',85,519,367,533,396,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi11.bmp',85,582,395,598,424,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi10.bmp',85,595,339,613,367,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)			
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi9.bmp',85,518,340,534,369,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)					
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi8.bmp',85,520,339,533,370,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)			
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi7.bmp',85,562,396,575,424,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi6.bmp',85,582,366,599,397,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi5.bmp',85,581,340,597,367,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi4.bmp',85,560,365,578,398,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi3.bmp',85,559,341,577,369,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi2.bmp',85,575,424,589,451,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)			
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi1.bmp',85,517,339,536,369,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)						
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,514,366,536,398,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)						
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,580,340,599,368,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,593,339,613,369,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,573,341,593,368,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,573,423,590,453,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)					
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,577,338,604,367,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)				
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,514,365,539,399,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)		
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,592,338,612,370,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,578,338,599,373,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,594,368,616,395,0xffffff)then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) and DmFindPicFuzzy('huangzi.bmp',85,537,333,582,419,0xffffff) then
			click(x-20,y+10) notifyMessage('任务黄字') mSleep(2000)
		--任务对话框
		elseif DmFindPic('x_dialog.bmp',90,1004,222,1017,236) or DmFindPic('x_dialog1.bmp',90,1001,226,1014,237) then
			clickone(x,y)  
		--立即转生
		elseif DmFindPic('lijizhuansheng.bmp',85,435,400,449,412) then
			click(x,y)  
...
function using(i)
	...
	while true do		
		...
		elseif DmFindPic('guizhongwuping.bmp',85,637,431,650,445) then
			click(x,y)
			mSleep(1000)
			if DmFindPic('x_all.bmp',90,1096,36,1112,50) then
				click(x,y)
			end
		--不存在的物品的X子
		--声望勋章
		elseif DmFindPic('sw.bmp',85,470,225,481,235) and DmFindPic('syxz.bmp',85,821,474,835,485) then
			click(x,y)
		elseif DmFindPic('sw1.bmp',85,469,266,480,276) and DmFindPic('syxz1.bmp',85,817,437,831,449) then
			click(x,y)		
		--误点其他地方导致卡屏
		elseif DmFindPic('x_all.bmp',90,1096,36,1112,50) then
			click(x,y)
...
function award()
	...
	while (i<3) do
		...
		elseif DmFindPic('peidai.bmp',90,712,507,722,518) or DmFindPic('peidai1.bmp',85,709,470,721,485) then
			clickone(x,y)			
		elseif DmFindPic('lingqu1.bmp',80,954,304,990,613)--[[ or DmFindPic('lingqu2.bmp',85,554,401,564,411,i)) and count < 4 --]]then
			click(x,y) mSleep(500)					
		--已经滑动到最下面了
		elseif DmFindPicFuzzy('san.bmp',80,954,304,990,613,0xffffff) and (DmFindPic('leijiliang.bmp',85,99,463,113,476) or isdj[i]==1 )then
			isok[i]=1
			closewin()
		elseif os.difftime(os.time(),time_table[i]) > 5 and ((DmFindPic('leijiliang.bmp',85,99,463,113,476) or isdj[i]==1) and DmFindPic('dafuli.bmp',90,596,49,613,63)) then
		...
		elseif DmFindPic('fuli.bmp',90,665,65,677,78) then
			click(x,y) mSleep(1500)				
		elseif DmFindPic('dafuli.bmp',90,596,49,613,63) and DmFindPic('leijidenglu.bmp',90,99,460,113,473) then
			click(x,y)		
			isdj[i]=1
		--关闭福利窗口
		elseif DmFindPic('x_ditu.bmp',90,617,243,625,252,i) then
...
--[[			appKill(packagename[i])
		...
		elseif DmFindPic('fuli.bmp',90,665,65,677,78) and DmFindPic('holiday.bmp',85,584,64,594,77)then
			click(x,y) 		
		elseif DmFindPic('dajieri.bmp',85,535,51,551,62) and DmFindPic('zhounian.bmp',85,97,188,112,204) then
			click(x,y)
			dianji[i]=1
		--领取节日
...
function weapon()
	...
	while (i<3) do
		changeApp(i)
		if os.difftime(os.time(),time_table[i]) > 90 and os.difftime(os.time(),time_table[2]) > 90 then
			closewin(1)
			closewin(2)
			break
		--连接断开立即重连与立即刷新
		...
		elseif isok[1]==1 and isok[2]==1 then
			closewin()
			break	
		elseif DmFindPic('lianlu.bmp',85,305,67,313,79) then
			click(x,y)
		elseif DmFindPic('lianlu.bmp',85,305,67,313,79) == false and DmFindPic('bag.bmp',90,831,615,842,628) and DmFindPic('head.bmp',85,10,50,21,60) then	
			click(x,y)mSleep(500)			
			if DmFindPic('lianlu.bmp',85,305,67,313,79) then
				click(x,y)mSleep(1000)
			end
		elseif DmFindPic('qianghua.bmp',90,412,580,426,593) and isfr[i]==1 then
			click(x,y)			
		--确认在强化界面放入装备
...
--[[			appKill(packagename[i])
		...
		elseif DmFindPic('dalianlu.bmp',85,599,49,613,64) and find_Onequyu(0xAA36D7,85,833,358,842,369) then
			...
			isfr[i]=1
		--确认在强化界面放入装备
		elseif DmFindPic('dalianlu.bmp',85,599,49,613,64)  and DmFindPic('shang.bmp',90,826,123,845,138) then
...
function bingfenggu()
	...
	while i<3 do
		...
		elseif DmFindPic('bing.bmp',90,1011,17,1023,32) == false and DmFindPic('sanjiao.bmp',90,1113,22,1126,33) then--1036,129
			click(x-80,y+100)
		elseif DmFindPic('daditu.bmp',90,595,50,611,63) and DmFindPic('sjdt.bmp',90,112,112,125,123) and isbfg[i] == 0 then
			click(x,y)
		--传送到冰风谷
